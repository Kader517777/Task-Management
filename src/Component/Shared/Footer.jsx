...
const Footer = () => {
    return (
        <footer className="footer items-center p-4 bg-neutral text-neutral-content max-w-[1024px] mx-auto">
            ...
            <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                <Link to={'https://www.linkedin.com/in/md-abdul-4b138b1b1/'}><CiLinkedin size={44} /></Link>
            </nav>
        </footer>
    );
};
